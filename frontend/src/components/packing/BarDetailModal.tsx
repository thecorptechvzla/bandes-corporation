...
import { ClipboardCheck, Camera, Check, Pencil, Lock, Shield, X } from 'lucide-react';
...
interface BarDetailModalProps {
  ...
  onClose: () => void;
  onValidate?: (data: { grossWeight: number; purity: number }) => void;
  isSaving?: boolean;
}
...
export function BarDetailModal({
  ...
  const handleSave = () => {
    ...
    onValidate({ grossWeight: bw, purity: la });
  };
      ...
      <ModalShell isOpen onClose={onClose} noHeader noPadding size="lg">
        ...
        <div className="p-6 space-y-5">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className={`p-3 rounded-xl border ${isEditing ? 'border-[var(--pm-accent-gold)]/40 bg-[var(--pm-accent-gold)]/5' : 'border-[var(--pm-accent-cyan)]/30 bg-[var(--pm-accent-cyan)]/5'}`}>
