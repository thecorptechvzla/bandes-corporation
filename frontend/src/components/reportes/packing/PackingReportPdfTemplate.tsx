          ...
          <tbody>
            {records.map((row, idx) => (
              <tr key={row.id}>
                ...
                <td style={{ borderBottom: '1px solid #e6e6e6', textAlign: 'right', backgroundColor: idx % 2 === 1 ? '#fbfdfc' : 'transparent' }}>{formatNumber(row.ley, 4)}</td>
            ...
            <tr>
              {[
                ...
                { text: formatNumber(summary.leyProm, 4), align: 'right' as const },
              ...
              <table style={{ width: '100%', tableLayout: 'fixed', borderCollapse: 'collapse', boxSizing: 'border-box' }}>
                ...
                <tbody>
                  ...
                  <tr className="pdf-subtotal-row">
                    ...
                    <td style={{ padding: '2px 4px', fontSize: '7.5px', backgroundColor: '#eaf4f0', borderTop: '2px solid #139169', textAlign: 'center', fontWeight: 700, color: '#139169' }}>{formatNumber(packing.ley, 4)}</td>
          ...
          <div className="pdf-totals-card" style={{ border: '2px solid #139169', borderRadius: '4px', overflow: 'hidden' }}>
            ...
            <div style={{ display: 'table', width: '100%', tableLayout: 'fixed' }}>
              ...
              <div style={{ display: 'table-cell', width: '33.34%', padding: '6px', textAlign: 'center' }}>
                ...
                <div className="pdf-totals-sub" style={{ color: '#666666', marginTop: '1px' }}>Ley Prom: {formatNumber(summary.leyProm, 4)}</div>
              </div>
            </div>
          </div>
        </>
